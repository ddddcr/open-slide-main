...
export const en: Locale = {
  ...
  home: {
    ...
    overviewDescription: 'Browse every demo and designed deck in this workspace.',
    summaryTotal: 'Total',
    summaryDraft: 'Draft',
    ...
    nothingMatchesAcrossAllPrefix: 'Nothing matches ',
    nothingMatchesAcrossAllSuffix: ' across all slides.',
